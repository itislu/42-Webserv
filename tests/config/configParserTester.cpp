...
//     "invalid_values/error_code_trailing_text.conf";
//   ConfigParser parser(configPath.c_str());
//   Config config;
//   EXPECT_THROW(config = parser.parseConfig(), std::invalid_argument);
// }
...
//   const std::string configPath =
//     std::string(ASSETS_PATH) +
//     "invalid_values/invalid_directive_global.conf";
//   ConfigParser parser(configPath.c_str());
//   Config config;
//   EXPECT_THROW(config = parser.parseConfig(), std::invalid_argument);
// }
...
//   const std::string configPath =
//     std::string(ASSETS_PATH) +
//     "invalid_values/invalid_directive_location.conf";
//   ConfigParser parser(configPath.c_str());
//   Config config;
//   EXPECT_THROW(config = parser.parseConfig(), std::invalid_argument);
// }
...
//   const std::string configPath =
//     std::string(ASSETS_PATH) +
//     "invalid_values/invalid_directive_server.conf";
//   ConfigParser parser(configPath.c_str());
//   Config config;
//   EXPECT_THROW(config = parser.parseConfig(), std::invalid_argument);
// }
...
//   const std::string configPath =
//     std::string(ASSETS_PATH) +
//     "invalid_values/port_non_number_included.conf";
//   ConfigParser parser(configPath.c_str());
//   Config config;
//   EXPECT_THROW(config = parser.parseConfig(), std::invalid_argument);
// }
...
//   const std::string configPath =
//     std::string(ASSETS_PATH) +
//     "overflow/overflow_bodysize_multiplier_B.conf";
//   ConfigParser parser(configPath.c_str());
//   Config config;
//   EXPECT_THROW(config = parser.parseConfig(), std::invalid_argument);
// }
...
//   const std::string configPath =
//     std::string(ASSETS_PATH) +
//     "overflow/overflow_bodysize_multiplier_G.conf";
//   ConfigParser parser(configPath.c_str());
//   Config config;
...
//   const std::string configPath =
//     std::string(ASSETS_PATH) +
//     "overflow/overflow_bodysize_multiplier_K.conf";
//   ConfigParser parser(configPath.c_str());
//   Config config;
//   EXPECT_THROW(config = parser.parseConfig(), std::overflow_error);
// }
...
//   const std::string configPath =
//     std::string(ASSETS_PATH) +
//     "overflow/overflow_bodysize_multiplier_M.conf";
//   ConfigParser parser(configPath.c_str());
//   Config config;
//   EXPECT_THROW(config = parser.parseConfig(), std::overflow_error);
// }
...
//   const std::string configPath =
//     std::string(ASSETS_PATH) +
//     "syntax_errors/semicolon_before_directive.conf";
//   ConfigParser parser(configPath.c_str());
//   Config config;
//   EXPECT_THROW(config = parser.parseConfig(), std::invalid_argument);
// }
...
// {
//   const std::string configPath = std::string(ASSETS_PATH) +
//   "valid/simple.conf"; ConfigParser parser(configPath.c_str()); Config
//   config; EXPECT_NO_THROW(config = parser.parseConfig());
