...
//   const LocationConfig* const loc1 =
//   server.getBestMatchLocation("/app/data"); ASSERT_TRUE(loc1 != NULL);
...
//   const LocationConfig* const loc1 =
//   server.getBestMatchLocation("/api/test"); ASSERT_TRUE(loc1 != NULL);
//   EXPECT_EQ(loc1->getPath(), "/api");

//   const LocationConfig* const loc2 =
//   server.getBestMatchLocation("/something"); ASSERT_TRUE(loc2 != NULL);
...
//   const LocationConfig* const loc =
//   server.getBestMatchLocation("/a/b/c/d/e"); ASSERT_TRUE(loc != NULL);
